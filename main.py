...
def avg_dis_r(data, start_to_end):
    final = []
...
start_to_end = [(1, 13), (1, 2), (1, 17), (13, 14), (2, 3), (17, 18), (14, 15), (3, 5), (3, 4), (3, 9), (18, 19), (15, 16), (5, 6), (9, 10), (19, 20), (6, 7), (10, 11), (7, 8), (11, 12)]
train = gd.loadData("train.p")
R = list(avg_dis_r(train, start_to_end))
print(len(R))
